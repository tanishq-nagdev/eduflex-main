  ...
  return (
    <div style={{padding: "2rem", minHeight:"100vh"}}>
      ...
      <form onSubmit={e=>{
        ...
        addMaterialToCourse(course.id, {
          title: materialTitle,
          type: materialFile ? "pdf" : "link",
          url: materialFile ? URL.createObjectURL(materialFile) : materialLink
        });
      ...
      <form onSubmit={e=>{
        ...
        addAssignmentToCourse(course.id, {
      ...
      <form onSubmit={e=>{
        ...
        addQuizToCourse(course.id, { title: quizTitle });
        setQuizTitle("");
